...
class ImportStellarBladeFBX(bpy.types.Operator, ImportHelper):
    """Load a FBX file"""
    bl_idname = "import_scene.stellar_blade_fbx"
    bl_label = "Import Stellar Blade FBX"
...
@orientation_helper(axis_forward='-Z', axis_up='Y')
class ExportStellarBladeFBX(bpy.types.Operator, ExportHelper):
    """Write a FBX file"""
    bl_idname = "export_scene.stellar_blade_fbx"
    bl_label = "Export Stellar Blade FBX"
    bl_options = {'UNDO', 'PRESET'}
    ...
    def execute(self, context):
        ...
        if self.stellar_blade_show_log:
            ...
            if not stellar_blade_log_window.start():
                self.report({'WARNING'}, "Could not show Stellar Blade FBX export log window")
...
class IO_FH_stellar_blade_fbx(bpy.types.FileHandler):
    ...
    bl_label = "Stellar Blade FBX"
    bl_import_operator = "import_scene.stellar_blade_fbx"
    bl_export_operator = "export_scene.stellar_blade_fbx"
...
def menu_func_import(self, context):
    self.layout.operator(ImportStellarBladeFBX.bl_idname, text="Stellar Blade FBX (.fbx)")


def menu_func_export(self, context):
    self.layout.operator(ExportStellarBladeFBX.bl_idname, text="Stellar Blade FBX (.fbx)")


classes = (
    ImportStellarBladeFBX,
    ExportStellarBladeFBX,
    IO_FH_stellar_blade_fbx,
)
